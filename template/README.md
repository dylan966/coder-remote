...
- **Auth**: `coder_app share=owner` —— only whoever is logged into your Coder account can
  open it. **This is the only access control**, so keep it in this template/subdomain
